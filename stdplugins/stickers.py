...
async def _(event):
    ...
    packname = f"@ViciPro's Pack"
    packshortname = f"@ViciPro's pack"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"@ViciPro's AnimatedStickers"
        packshortname = f"@ViciPro AS"  # format: Uni_Borg_userid
